    ...
    <div class="container">
      <div class="row">
              ...
              <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6">
                  <div class="blog__details__btn__item">
                    <h6>
                      <a href="#"
                        ><i class="fa fa-angle-left"></i> Previous posts</a
                      >
                    </h6>
                  </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-6">
                  <div
                    class="blog__details__btn__item blog__details__btn__item--next"
                  >
                    <h6>
                      <a href="#"
        ...
        <div class="col-lg-4 col-md-4">
          <the-blog-sidebar></the-blog-sidebar>
        </div>
      </div>
    </div>
  </section>
...
<script>
import TheBlogSidebar from "@/components/TheBlogSidebar.vue";
export default {
  components: {
    TheBlogSidebar,
  },
